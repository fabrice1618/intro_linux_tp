...
QCM = {
  1: [("Rechercher dans man :", ["A) ?mot","B) /mot","C) :mot","D) @mot"], "B"),
  ...
  2: [("Quelle variable pointe sur le répertoire courant affiché par la commande qui l'imprime ?", ["A) $HOME","B) $PWD","C) $USER","D) $PATH"], "B"),
  ...
  3: [("Quel préfixe rend un nom de fichier caché ?", ["A) .","B) _","C) ~","D) -"], "A"),
  ...
  4: [("Copie récursive :", ["A) -a","B) -R","C) -p","D) -v"], "B"),
  ...
  5: [("Ignorer la casse dans la recherche texte :", ["A) -n","B) -i","C) -v","D) -w"], "B"),
  ...
  6: [("Supprimer doublons consécutifs :", ["A) uniq","B) sort","C) cut","D) tr"], "A"),
  ...
  7: [("Créer une archive tar :", ["A) -x","B) -t","C) -c","D) -z"], "C"),
  ...
  8: [("Créer un lien symbolique :", ["A) -h","B) -s","C) -L","D) -P"], "B"),
  ...
  9: [("Exporter une variable :", ["A) env","B) export","C) set","D) declare sans -x"], "B"),
 ...
 10: [("Lister processus utilisateur :", ["A) ps -u $(whoami)","B) top","C) jobs -l","D) pstree"], "A"),
...
def step1():
    # Étape 1: Aide, historique, horloge (ancienne step10)
    passed = True
...
def step2():
    # Étape 2: Se repérer (ancienne step1)
    passed = True
    if BASE.exists():
...
def step3():
    # Étape 3: Créer dossiers et fichiers (ancienne step2)
    passed = True
    ws = BASE / "workspace"
...
def step4():
    # Étape 4: Copier, déplacer, renommer, supprimer (ancienne step3)
    passed = True
    ws = BASE / "workspace"
...
def step6():
    # Étape 6: Filtres et pipes (ancienne step5)
    passed = True
...
def step7():
    # Étape 7: Archiver (ancienne step6)
    passed = True
...
def step8():
    # Étape 8: Liens et permissions (ancienne step7)
    passed = True
...
def step9():
    # Étape 9: Variables et alias (ancienne step8)
    passed = True
...
def step10():
    # Étape 10: Processus (ancienne step9)
    passed = True
